...
{ "ER_MASTER_DELAY_VALUE_OUT_OF_RANGE", 1729, "The requested value %u for the master delay exceeds the maximum %u" },
...
{ "ER_INSECURE_CHANGE_MASTER", 1760, "Storing MySQL user name or password information in the master.info repository is not secure and is therefore not recommended. Please see the MySQL Manual for more about this issue and possible alternatives." },
...
{ "ER_CANT_DO_IMPLICIT_COMMIT_IN_TRX_WHEN_GTID_NEXT_IS_SET", 1778, "Cannot execute statements with implicit commit inside a transaction when @@SESSION.GTID_NEXT != AUTOMATIC or @@SESSION.GTID_NEXT_LIST != NULL." },
